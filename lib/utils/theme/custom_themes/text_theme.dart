...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0,fontWeight: FontWeight.w700,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0,fontWeight: FontWeight.w700,color: Colors.white),
    headlineSmall: const TextStyle().copyWith(fontSize: 16.0,fontWeight: FontWeight.w700,color: Colors.white),
